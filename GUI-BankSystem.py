...
def Cr_Amt(accnt,name):
	...
	l_title=tk.Message(creditwn,text="24/7 ATM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	l_title=tk.Message(debitwn,text="24/7 ATM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def disp_tr_hist(accnt):
	...
	l_title=tk.Message(disp_wn,text="24/7 ATM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	rootwn.title("24/7 ATM-"+name)
	rootwn.configure(background='gray')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	bg_image = tk.PhotoImage(file ="home.gif")
	fr1.pack(side="top")
	l_title=tk.Message(rootwn,text="WELCOME TO ATM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	...
	l_title=tk.Message(loginwn,text="24/7 ATM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	...
	l2.pack(side="left")
	l2.place(x=160,y=108)
	e2=tk.Entry(loginwn)
	e2.pack(side="top")
	e2.place(x=350,y=108)
	l3=tk.Label(loginwn,text="Enter your PIN:",relief="raised")
	l3.pack(side="top")
	l3.place(x=160,y=138)
	e3=tk.Entry(loginwn,show="*")
	e3.pack(side="top")
	e3.place(x=350,y=142)
...
def Create():
	...
	l_title=tk.Message(crwn,text="24/7 ATM",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	x.place(x=500,y=40)
	l_title=tk.Message(text="WELCOME TO ATM ",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="black",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
